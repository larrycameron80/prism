...
typedef struct or_connection_t {
  ...
  uint64_t passive_info_hashtable_key;
} or_connection_t;
...
/**
* Added By Behrooz
* 2013-06-30  6:18:55 PM
* Purpose: How often write Passive Information?
* 1 hour!
**/
#define WRITE_BRIDGE_PASSIVE_INFO_INTERVAL (30)
/**
* Added By Behrooz
* 2013-06-30  6:18:55 PM
* Purpose: How often we should change hmac key for passive info?
* 1 week!
**/
#define HMAC_KEY_CHANGE_BRIDGE_PASSIVE_INFO_INTERVAL (7*24*60*60)
